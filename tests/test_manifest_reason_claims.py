...
def test_the_reasons_that_make_checkable_claims_are_the_ones_declared():
    ...
    assert declared == [
        ...
        "cellstructuremech.metpo_proposal",
        ...
        "naturalproductmech.curation_history",
        "naturalproductmech.deep_research",
        "naturalproductmech.metpo_proposal",
        ...
        "taxonmech.deep_research",
        "taxonmech.metpo_proposal",
        "taxonmech.page_budgets",
        "taxonmech.source_catalogue",
        "taxonmech.source_queue",
        "taxonmech.writer_audit",
